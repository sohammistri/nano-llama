...
def _patch_missing_config_keys(model_config_kwargs):
    ...
    # Old checkpoints don't have arch field — default to "gpt"
    if "arch" not in model_config_kwargs:
...
def build_model(checkpoint_dir, step, device, phase):
    ...
    model_config, model_cls = build_model_from_config(arch, model_config_kwargs)
